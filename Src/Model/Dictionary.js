...
var Dictionary = /** @class */ (function () {
    ...
    Dictionary.showWord = function () {
        ...
        if (word !== undefined) {
            ...
            console.log("---------------");
            console.log("Synonyms: ".concat(word.synonyms));
        }
        else
    ...
    Dictionary.editWord = function () {
        ...
        if (word !== undefined) {
            while (true) {
                ...
                switch (number) {
                    case Choice_1.editWord.changeName:
                        word.setName();
                        (0, DBHelper_1.writeWordsData)();
                        break;
                    case Choice_1.editWord.changePronoun:
                        word.setPronoun();
                        (0, DBHelper_1.writeWordsData)();
                        break;
                    case Choice_1.editWord.changeTypes:
                        word.editTypes();
                        (0, DBHelper_1.writeWordsData)();
                        break;
                    case Choice_1.editWord.changeSyns:
                        word.editSynonyms();
                        (0, DBHelper_1.writeWordsData)();
                        break;
                    case Choice_1.editWord.exit:
                        return;
                }
            }
        }
