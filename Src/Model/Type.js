...
var Type = /** @class */ (function () {
    ...
    Type.prototype.edit = function () {
        while (true) {
            ...
            switch (number) {
                case Choice_1.editOneType.changeName:
                    this.setNameOfType();
                    break;
                case Choice_1.editOneType.editMeanings:
                    while (true) {
                        (0, Menu_1.subMenuEditMeanings)();
                        var number_1 = +readlineSync.question('Choose action:  ');
                        switch (number_1) {
                            case Choice_1.editMeanings.addMeaning:
                                this.addMeaning();
                                break;
                            case Choice_1.editMeanings.deleteMeaning:
                                this.deleteMeaning();
                                break;
                            case Choice_1.editMeanings.editOneMeaning:
                                try {
                                ...
                                break;
                            case Choice_1.editMeanings.exit:
                                return;
                        }
                    }
                case Choice_1.editOneType.exit:
                    return;
            }
        }
    };
